...
public interface DdBookPersonRepository extends JpaRepository<DdBookPerson, Long> {
    ...
    @Query(value = "select distinct ddBookPerson from DdBookPerson ddBookPerson left join fetch ddBookPerson.depts",
    ...
    @Query("select distinct ddBookPerson from DdBookPerson ddBookPerson left join fetch ddBookPerson.depts")
    List<DdBookPerson> findAllWithEagerRelationships();

    @Query("select ddBookPerson from DdBookPerson ddBookPerson left join fetch ddBookPerson.depts where ddBookPerson.id =:id")

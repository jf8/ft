...
export default class DdBookPersonFt extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllDdBookPersonFts();
  }
  ...
  public retrieveAllDdBookPersonFts(): void {
  ...
  public prepareRemove(instance: IDdBookPersonFt): void {
  ...
  public removeDdBookPersonFt(): void {
    this.ddBookPersonService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('ftApp.ddBookPerson.deleted', { param: this.removeId });

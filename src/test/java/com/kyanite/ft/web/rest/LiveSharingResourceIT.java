...
public class LiveSharingResourceIT {
    ...
    private static final String DEFAULT_CONF_NUMBER = "AAAAAAAAAA";
    private static final String UPDATED_CONF_NUMBER = "BBBBBBBBBB";
    ...
    public static LiveSharing createEntity(EntityManager em) {
        LiveSharing liveSharing = new LiveSharing()
            .name(DEFAULT_NAME)
            .day(DEFAULT_DAY)
            .confNumber(DEFAULT_CONF_NUMBER);
        return liveSharing;
    }
    /**
    ...
    public static LiveSharing createUpdatedEntity(EntityManager em) {
        LiveSharing liveSharing = new LiveSharing()
            .name(UPDATED_NAME)
            .day(UPDATED_DAY)
            .confNumber(UPDATED_CONF_NUMBER);
        return liveSharing;
    }
    ...
    public void createLiveSharing() throws Exception {
        ...
        assertThat(testLiveSharing.getConfNumber()).isEqualTo(DEFAULT_CONF_NUMBER);
    }
    ...
    public void getAllLiveSharings() throws Exception {
        ...
        restLiveSharingMockMvc.perform(get("/api/live-sharings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].confNumber").value(hasItem(DEFAULT_CONF_NUMBER)));
    }
    ...
    public void getLiveSharing() throws Exception {
        ...
        restLiveSharingMockMvc.perform(get("/api/live-sharings/{id}", liveSharing.getId()))
            ...
            .andExpect(jsonPath("$.confNumber").value(DEFAULT_CONF_NUMBER));
    }
    @Test
    @Transactional
    ...
    public void updateLiveSharing() throws Exception {
        ...
        assertThat(testLiveSharing.getConfNumber()).isEqualTo(UPDATED_CONF_NUMBER);
    }

...
public class ProcessInstanceInputVO {
     ...
     * 单行输入框、多行输入框的表单数据
     */
    private List<TextForm> textForms = Lists.newArrayList();

    /**
     * 图片表单数据
     */
    private List<PictureForm> pictureForms = Lists.newArrayList();

    /**
     * 明细表单数据
     */
    private List<DetailForm> detailForms = Lists.newArrayList();
    ...
    public void addTextForms(TextForm textForm) {
        this.textForms.add(textForm);
    }
    ...
    public void addPictureForms(PictureForm pictureForm) {
        this.pictureForms.add(pictureForm);
    }
    ...
    public void addDetailForms(DetailForm detailForm) {
        this.detailForms.add(detailForm);
    }
